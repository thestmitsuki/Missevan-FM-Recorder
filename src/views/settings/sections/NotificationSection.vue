        ...
        >
            ...
            <Card class="gap-0 rounded-lg p-4 shadow-none">
                <CardHeader class="mb-3 gap-0 p-0">
                    <CardTitle class="text-sm font-semibold">{{ t("settings.notification.eventsTitle") }}</CardTitle>
                </CardHeader>
            ...
            <Card class="gap-0 rounded-lg p-4 shadow-none">
                <CardHeader class="mb-3 gap-0 p-0">
                    <CardTitle class="text-sm font-semibold">{{ t("settings.notification.channelTitle") }}</CardTitle>
                </CardHeader>
                <CardContent class="p-0">
                    <div class="space-y-3">
                        <div class="flex items-center gap-2">
