    ...
    <div class="space-y-6">
        ...
        <Card class="gap-0 rounded-lg p-4 shadow-none">
            <CardHeader class="mb-3 gap-1 p-0">
                ...
                <p class="text-xs text-muted-foreground">{{ t("settings.advanced.logLevelHint") }}</p>
            </CardHeader>
        ...
        <Card class="gap-0 rounded-lg p-4 shadow-none">
            <CardHeader class="mb-4 gap-0 p-0">
                <CardTitle class="text-sm font-semibold">{{ t("settings.advanced.detectionTitle") }}</CardTitle>
            </CardHeader>
            <CardContent class="p-0">
        ...
        <Card class="gap-0 rounded-lg p-4 shadow-none">
            <CardHeader class="mb-4 gap-0 p-0">
                <CardTitle class="text-sm font-semibold">{{ t("settings.advanced.pathsTitle") }}</CardTitle>
            </CardHeader>
            <CardContent class="p-0">
                <div class="space-y-4">
                    <div class="space-y-1.5">
        ...
        <Card class="gap-0 rounded-lg p-4 shadow-none">
            <CardHeader class="mb-4 gap-0 p-0">
                <CardTitle class="text-sm font-semibold">{{ t("settings.advanced.actionsTitle") }}</CardTitle>
            </CardHeader>
            <CardContent class="p-0">
